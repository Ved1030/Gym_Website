          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative flex flex-col rounded-2xl border transition-all duration-300 h-[560px] ${
                plan.popular
                  ? 'border-primary/40 bg-gradient-to-b from-primary/[0.08] to-transparent shadow-[0_0_40px_rgba(220,38,38,0.15)] md:scale-[1.02]'
                  ...
                  <a href="#trial" className="block">
                    <motion.button
                      ...
                      className={`w-full py-3.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300 ${
                        plan.popular
                          ? 'bg-primary text-primary-foreground shadow-[0_0_20px_rgba(220,38,38,0.3)] hover:shadow-[0_0_30px_rgba(220,38,38,0.5)]'
