                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="relative flex flex-col items-center">
                    <div className="animate-bounce-slow">
                      <MapPin className="h-8 w-8 sm:h-9 sm:w-9 lg:h-10 lg:w-10 text-[#FF3B3B] drop-shadow-[0_0_12px_rgba(255,59,59,0.7)]" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm md:font-semibold truncate">+91 98765 43210</p>
                </div>
              </a>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4 mt-6 md:mt-8 pt-5 md:pt-6 border-t border-white/10">
              ...
              <div className="text-center border-x border-white/10">
                ...
                <p className="text-base md:text-lg font-bold">103+</p>
