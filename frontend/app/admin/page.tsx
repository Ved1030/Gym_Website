    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground text-center mb-6">Evolve Fitness Dashboard</p>
  ...
  return (
    <div className="min-h-screen bg-background">
      <nav className="sticky top-0 z-50 glass border-b border-border/50 px-4 h-14 flex items-center justify-between">
        ...
        <span className="font-bold text-sm"><span className="text-primary">EVOLVE</span> ADMIN</span>
