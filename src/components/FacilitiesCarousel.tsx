        ...
        <div className="h-full w-full flex flex-col items-center justify-center px-6 sm:px-10">
          <div className="w-full max-w-[1800px] flex flex-col">
            <div className="shrink-0 text-center mb-8 sm:mb-10 lg:mb-12">
              <p className="text-sm text-red-400 font-semibold tracking-[0.3em] uppercase">
                OUR FACILITIES
              </p>
              <div className="h-5" />
                  ...
                  {facilities.map((f, i) => (
                    ...
                    >
                      ...
                      <div className="absolute bottom-[40px] left-[32px] right-[32px] z-10">
                        <span className="text-base text-red-400 font-semibold tracking-[0.2em] uppercase block mb-4">
                          {f.zone}
                        </span>
                        <h3 className="md:text-[48px] text-4xl font-bold font-serif mb-4 leading-[1.1]">
                          {f.name}
                        </h3>
                        <p className="text-xl text-gray-300 font-light mb-5 leading-snug opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-out">
                          {f.subtitle}
                        </p>
                        <p className="text-base text-gray-400 leading-relaxed opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-out">
                          {f.desc}
                        </p>
                      </div>
                    </motion.div>
