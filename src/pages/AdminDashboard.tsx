    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
        <form onSubmit={login} className="bg-white/5 p-8 rounded-2xl w-full max-w-sm space-y-4">
          ...
          <button type="submit" className="w-full h-12 bg-red-600 rounded-xl font-semibold text-white hover:bg-red-700">
            Login
          </button>
        </form>
      </div>
  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-bold"><span className="text-red-500">GYM MANTRA</span> ADMIN</h1>
        <button
